...
<section class="container my-5">
    <h2 class="text-center mb-4">Customer Messages</h2>
    <div class="row">
        <?php if (!empty($approved_messages)): ?>
                ...
                <div class="col-md-6 mb-4">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle mb-2 text-muted"><?= htmlspecialchars($msg->subject) ?></h6>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p class="text-center">No messages available yet.</p>
        <?php endif; ?>
    </div>
</section>
