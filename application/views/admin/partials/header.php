...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="https://cdn.pixabay.com/photo/2017/02/15/00/48/logo-2067396__480.png">
...
<body class="bg-white">
    ...
    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
        <a class="dropdown-item" href="<?php echo base_url().'admin/contact'; ?>">
